...
Route::get('/authorize/{provider}/redirect', [\App\Http\Controllers\Api\SocialAuthorizationController::class, 'redirectToProvider']);
Route::get('/authorize/{provider}/callback', [\App\Http\Controllers\Api\SocialAuthorizationController::class, 'handleProviderCallback']);
